...
def build_system_prompt(has_context: bool = False) -> str:
    """System prompt صارم — يجيب فقط من البيانات المرفوعة ولا يستخدم معرفته العامة."""
    base = (
        ...
        "• [حرج] لا تجب من معرفتك العامة تحت أي ظرف — اجب فقط من النصوص المسترجعة من قاعدة المعرفة.\n"
        "• [حرج] إذا لم يكن هناك سياق قانوني مسترجع، لا تجب من معلوماتك الشخصية — قل إن المصدر غير مرفوع.\n"
    )
    if has_context:
        return base + (
