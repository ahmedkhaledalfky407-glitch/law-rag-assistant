...
def build_system_prompt(has_context: bool = False) -> str:
    """System prompt مرن — يجيب فقط من البيانات المرفوعة مع مرونة في التعامل."""
    base = (
        ...
        "• لا تجب من معرفتك العامة أبدًا — اجب فقط من النصوص المسترجعة من قاعدة المعرفة.\n"
    )
    if has_context:
        return base + (
            "\nالسياق القانوني التالي مسترجع من قاعدة المعرفة — اجب فقط من هذا السياق:\n"
            "• اعتمد على النصوص الواردة في السياق فقط ولا تستخدم أي معلومات أخرى.\n"
